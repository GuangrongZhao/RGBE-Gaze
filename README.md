...
@inproceedings{  
  ...
  booktitle = {IEEE Transactions on Pattern Analysis and Machine Intelligence (TPAMI) 2024},
  year = {2024}  
} 
```
...
#### 4. click_gt_cpu.txt
**click_gt_cpu.txt** records the sparse PoG ground truth and the CPU timestamp when subject click the stationary stimulus.
