...
The **RGBE_Gaze_dataset** folder consists of the data generated by FLIR BFS-U3-16S2C (RGB Images), Prophesee EVK4 (Event Streams), Gazepoint GP3 HD (Gaze References) and mouse click positions on the screen (Sparse PoG ground truth)
