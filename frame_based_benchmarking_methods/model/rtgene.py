...
class model(nn.Module):
    def __init__(self):
        ...
        self.leftEyeNet[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3,3), stride=(1, 1), padding=(1, 1))
        self.rightEyeNet[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3,3), stride=(1, 1), padding=(1, 1))
    ...
    def forward(self, left, right, head_pose):
        leftFeature = self.leftEyeNet(left)
        rightFeature = self.rightEyeNet(right)
        ...
        feature = torch.cat((feature, head_pose), 1)
...
if __name__ == '__main__':
    ...
    head_pose = torch.zeros(10, 2).cuda()
    left = torch.zeros(10, 1, 36, 60).cuda()
    right = torch.zeros(10, 1, 36, 60).cuda()


    a = m(left,right,head_pose)
    print(m)