...
if __name__ == "__main__":
    ...
    if args.network == "GazeNet":
        ...
        state_dict = torch.load(
            'G:/remote_apperance_gaze_dataset/processed_data/pre_trained_models_for_frame_method_eva/checkpoints/minist_R_eye_Iter_10.pt', map_location=torch.device('cuda:0' if torch.cuda.is_available() else 'cpu'))
    print(model)
    ...
    for user in userlist:
        ...
        with open(os.path.join("G:/remote_apperance_gaze_dataset/processed_data/pre_trained_models_for_frame_method_eva/ui_minist/user_" + str(user)+ "R"), 'w') as outfile:
