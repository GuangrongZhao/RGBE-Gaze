...
%         
%          mkdir(['C:\Users\Aiot_Server\Desktop\remote_dataset\voxel_grid_representation_visualization/user_',num2str(i),'/exp',num2str(j),'/voxel_grid_saved/left_eye']);
% 
%          mkdir(['C:\Users\Aiot_Server\Desktop\remote_dataset\voxel_grid_representation_visualization/user_',num2str(i),'/exp',num2str(j),'/voxel_grid_for_eye_tracker/left_eye']);
%         
%          mkdir(['C:\Users\Aiot_Server\Desktop\remote_dataset\voxel_grid_representation_visualization/user_',num2str(i),'/exp',num2str(j),'/voxel_grid_saved/right_eye']);
% 
%          mkdir(['C:\Users\Aiot_Server\Desktop\remote_dataset\voxel_grid_representation_visualization/user_',num2str(i),'/exp',num2str(j),'/voxel_grid_for_eye_tracker/right_eye']);
%         

         
                  mkdir(['G:/remote_apperance_gaze_dataset/processed_data/user_',num2str(i),'/exp',num2str(j),'/convert_frame_normalized/']);
                  mkdir(['G:/remote_apperance_gaze_dataset/processed_data/user_',num2str(i),'/exp',num2str(j),'/convert_frame_normalized/face']);
                  mkdir(['G:/remote_apperance_gaze_dataset/processed_data/user_',num2str(i),'/exp',num2str(j),'/convert_frame_normalized/left_eye']);
                  mkdir(['G:/remote_apperance_gaze_dataset/processed_data/user_',num2str(i),'/exp',num2str(j),'/convert_frame_normalized/right_eye']);
...
%    
% if exist(['C:\Users\Aiot_Server\Desktop\remote_dataset\voxel_grid_representation\user_',num2str(i),'\exp',num2str(j)'], 'dir')
%         rmdir(['C:\Users\Aiot_Server\Desktop\remote_dataset\voxel_grid_representation\user_',num2str(i),'\exp',num2str(j)'],'s');
%         
% end
