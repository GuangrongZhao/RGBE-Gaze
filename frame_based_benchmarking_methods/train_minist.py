...
#################################### Configure data loader#################################################
    ...
    with open(os.path.join("G:/remote_apperance_gaze_dataset/processed_data/pre_trained_models/", f"minist_R_eye"), 'w') as outfile:
        for epoch in tqdm(range(args.epoch)):
            ...
            if epoch % 10== 0:
               torch.save(model.state_dict(), os.path.join('G:/remote_apperance_gaze_dataset/processed_data/pre_trained_models/checkpoints/', f"minist_R_eye_Iter_{epoch}.pt"))
