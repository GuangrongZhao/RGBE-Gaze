...
if __name__ == "__main__":
    ...
    with open(os.path.join(args.model_save_path, f"minist_R_eye"), 'w') as outfile:
        for epoch in tqdm(range(args.epoch)):
            ...
            #
            if epoch % 10 == 0:
                torch.save(model.state_dict(), os.path.join(args.model_save_path, f"minist_R_eye_Iter_{epoch}.pt"))
