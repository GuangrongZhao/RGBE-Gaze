...
#################################### Configure data loader#################################################
    ...
    with open(os.path.join("/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/", f"inpaper_no_scale_MPIIGazempgmodelminist_first_left_num"), 'w') as outfile:
...
# [{i}/{length}
            ...
            if epoch % 10== 0:
               torch.save(model.state_dict(), os.path.join('/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/checkpoints/', f"inpaper_Iter_{epoch}_no_scale_MPIIGazempgmodelminist_first_left.pt"))
