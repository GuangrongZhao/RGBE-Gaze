...
if __name__ == "__main__":
    ...
    state_dict = torch.load('/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/checkpoints/only_frame_new_Iter_80_same_parame_no_scale_DilatedNet_first_right.pt')
    ...
    for user in userlist:
        ...
        for ii in range(user,user+1):
            for jj in [1,2,3,4,5,6]:
                    ...
                    f_data = h5py.File(os.path.join('/home/sduu2/桌面/data_for_voxel_grid_only_frame/64_96_R_eye_normalized_user_'+str(ii)+'_exp'+str(jj)+'.h5'),'r')   #创建一个h5文件，文件指针是f
                    f_label = h5py.File(os.path.join('/home/sduu2/桌面/data_for_voxel_grid_only_frame/R_pitch_yaw_user_'+str(ii)+'_exp'+str(jj)+'.h5'),'r')   #创建一个h5文件，文件指针是f
                    f_head = h5py.File(os.path.join('/home/sduu2/桌面/data_for_voxel_grid_only_frame/R_headpose_user_'+str(ii)+'_exp'+str(jj)+'.h5'),'r')   #创建一个h5文件，文件指针是f
    ...
    #################################### Configure data loader#################################################
        ...
        with open(os.path.join("/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/ui_dilatednet_only_frame/user_" + str(user)+ "R"), 'w') as outfile:
            for epoch in tqdm(range(args.epoch)):
                ...
                # state_dict = torch.load('/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/checkpoints/Iter_50_no_scale_MPIIGazempgmodelvgg_first_left.pt')
