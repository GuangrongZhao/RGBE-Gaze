...
class model(nn.Module):
    def __init__(self):
        ...
        self.convNet[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(3,3), stride=(1, 1), padding=(1, 1))
    ...
    def forward(self, x_in,headpose):
        feature = self.convNet(x_in)
        feature = torch.flatten(feature, start_dim=1)
        feature = self.FC(feature)

        feature = torch.cat((feature,headpose), 1)
