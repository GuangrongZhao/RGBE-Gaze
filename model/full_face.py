...
class model(nn.Module):
    def __init__(self):
        ...
        self.convNet[0] = nn.Conv2d(in_channels=1, out_channels=64, kernel_size=(11,11), stride=(4, 4), padding=(2, 2))
...
if __name__ == '__main__':
    ...
    feature = {"head_pose": torch.zeros(10, 2).cuda(),
               ...
               "face": torch.zeros(10, 1, 448 , 448).cuda()
               }

    feature = torch.zeros(10, 1, 448,448).cuda()
