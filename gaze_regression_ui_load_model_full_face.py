...
if __name__ == "__main__":
    ...
    state_dict = torch.load('/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/checkpoints/448_Iter_20_no_scale_full_face_first_left.pt')
    ...
    #################################### Configure data loader#################################################
        ...
        with open(os.path.join("/home/sduu2/userspace/zgr/remote_eyetracking/python_code/Tpami_final_result/ui_full_face/user_" + str(user)+ "R"), 'w') as outfile:
